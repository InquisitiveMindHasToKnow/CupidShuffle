...
public class FinanceQuestion3 extends AppCompatActivity {
    ...
    private String[] financeQuestion3_choices;

    private TextView financeQuestion3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finance_question3);

        financeQuestions = getResources().getStringArray(R.array.finance_surveyQuestions_array);
        financeQuestion3_choices = getResources().getStringArray(R.array.finance_surveyChoices_question3_array);
    ...
    private void setViews() {
        financeQuestion3.setText(financeQuestions[2]);

        yourChoice1.setText(financeQuestion3_choices[0]);
        yourChoice2.setText(financeQuestion3_choices[1]);
        yourChoice3.setText(financeQuestion3_choices[2]);

        acceptedChoice1.setText(financeQuestion3_choices[0]);
        acceptedChoice2.setText(financeQuestion3_choices[1]);
        acceptedChoice3.setText(financeQuestion3_choices[2]);
        ...
        yourChoices.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.finance_question3_yourChoice1_button:
                        editor.putString(USER_CHOICE1_KEY, yourChoice1.getText().toString());
                        break;

                    case R.id.finance_question3_yourChoice2_button:
                        editor.putString(USER_CHOICE2_KEY, yourChoice2.getText().toString());
                        break;

                    case R.id.finance_question3_yourChoice3_button:
        ...
        saveAnswer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent saveIntent = new Intent(FinanceQuestion3.this, FinanceQuestion4.class);
                editor.apply();
                FinanceQuestion3.this.finish();
        ...
        skipAnswer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent skipIntent = new Intent(FinanceQuestion3.this, FinanceQuestion4.class);
                FinanceQuestion3.this.finish();
    ...
    private void findViews() {
        financeQuestion3 = findViewById(R.id.finance_question3_text);

        yourChoices = findViewById(R.id.finance_question3_radioGroup);
        yourChoice1 = findViewById(R.id.finance_question3_yourChoice1_button);
        yourChoice2 = findViewById(R.id.finance_question3_yourChoice2_button);
        yourChoice3 = findViewById(R.id.finance_question3_yourChoice3_button);

        acceptedChoice1 = findViewById(R.id.finance_question3_acceptedChoice1_checkbox);
        acceptedChoice2 = findViewById(R.id.finance_question3_acceptedChoice2_checkbox);
        acceptedChoice3 = findViewById(R.id.finance_question3_acceptedChoice3_checkbox);

        explainAnswer = findViewById(R.id.explainAnswer_finance3_editText);
        revealAnswerSwitch = findViewById(R.id.questionPrivacy_finance3_toggleSwitch);

        saveAnswer = findViewById(R.id.save_finance_Question3_button);
        skipAnswer = findViewById(R.id.skip_finance_Question3_button);
    }
}
