...
public class SexQuestion3 extends AppCompatActivity {
    ...
    private String[] sexQuestion3_choices;

    private TextView sexQuestion3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sex_question3);

        sexQuestions = getResources().getStringArray(R.array.sex_surveyQuestions_array);
        sexQuestion3_choices = getResources().getStringArray(R.array.sex_surveyChoices_question3_array);
    ...
    private void setViews() {
        sexQuestion3.setText(sexQuestions[2]);

        yourChoice1.setText(sexQuestion3_choices[0]);
        yourChoice2.setText(sexQuestion3_choices[1]);
        yourChoice3.setText(sexQuestion3_choices[2]);
        yourChoice4.setText(sexQuestion3_choices[3]);

        acceptedChoice1.setText(sexQuestion3_choices[0]);
        acceptedChoice2.setText(sexQuestion3_choices[1]);
        acceptedChoice3.setText(sexQuestion3_choices[2]);
        acceptedChoice4.setText(sexQuestion3_choices[3]);
        ...
        saveAnswer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent saveIntent = new Intent(SexQuestion3.this, SexQuestion4.class);
                editor.apply();
                SexQuestion3.this.finish();
        ...
        skipAnswer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent skipIntent = new Intent(SexQuestion3.this, SexQuestion4.class);
                SexQuestion3.this.finish();
    ...
    private void findViews() {
        sexQuestion3 = findViewById(R.id.sex_question3_text);

        yourChoices = findViewById(R.id.sex_question3_radioGroup);
        yourChoice1 = findViewById(R.id.sex_question3_yourChoice1_button);
        yourChoice2 = findViewById(R.id.sex_question3_yourChoice2_button);
        yourChoice3 = findViewById(R.id.sex_question3_yourChoice3_button);
        yourChoice4 = findViewById(R.id.sex_question3_yourChoice4_button);

        acceptedChoice1 = findViewById(R.id.sex_question3_acceptedChoice1_checkbox);
        acceptedChoice2 = findViewById(R.id.sex_question3_acceptedChoice2_checkbox);
        acceptedChoice3 = findViewById(R.id.sex_question3_acceptedChoice3_checkbox);
        acceptedChoice4 = findViewById(R.id.sex_question3_acceptedChoice4_checkbox);

        explainAnswer = findViewById(R.id.explainAnswer_sex3_editText);
        revealAnswerSwitch = findViewById(R.id.questionPrivacy_sex3_toggleSwitch);

        saveAnswer = findViewById(R.id.save_sex_Question3_button);
        skipAnswer = findViewById(R.id.skip_sex_Question3_button);
    }
}