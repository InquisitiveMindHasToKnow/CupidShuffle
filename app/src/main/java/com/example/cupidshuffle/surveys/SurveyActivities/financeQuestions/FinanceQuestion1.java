...
public class FinanceQuestion1 extends AppCompatActivity {
    ...
    private String[] financeQuestion1_choices;

    private TextView financeQuestion1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finance_question1);

        financeQuestions = getResources().getStringArray(R.array.finance_surveyQuestions_array);
        financeQuestion1_choices = getResources().getStringArray(R.array.finance_surveyChoices_question1_array);
    ...
    private void setViews() {
        financeQuestion1.setText(financeQuestions[0]);

        yourChoice1.setText(financeQuestion1_choices[0]);
        yourChoice2.setText(financeQuestion1_choices[1]);
        yourChoice3.setText(financeQuestion1_choices[2]);
        yourChoice4.setText(financeQuestion1_choices[3]);

        acceptedChoice1.setText(financeQuestion1_choices[0]);
        acceptedChoice2.setText(financeQuestion1_choices[1]);
        acceptedChoice3.setText(financeQuestion1_choices[2]);
        acceptedChoice4.setText(financeQuestion1_choices[3]);
    ...
    private void findViews() {
        financeQuestion1 = findViewById(R.id.finance_question1_text);

        yourChoices = findViewById(R.id.finance_question1_radioGroup);
        yourChoice1 = findViewById(R.id.finance_question1_yourChoice1_button);
        yourChoice2 = findViewById(R.id.finance_question1_yourChoice2_button);
        yourChoice3 = findViewById(R.id.finance_question1_yourChoice3_button);
        yourChoice4 = findViewById(R.id.finance_question1_yourChoice4_button);

        acceptedChoice1 = findViewById(R.id.finance_question1_acceptedChoice1_checkbox);
        acceptedChoice2 = findViewById(R.id.finance_question1_acceptedChoice2_checkbox);
        acceptedChoice3 = findViewById(R.id.finance_question1_acceptedChoice3_checkbox);
        acceptedChoice4 = findViewById(R.id.finance_question1_acceptedChoice4_checkbox);

        explainAnswer = findViewById(R.id.explainAnswer_finance1_editText);
        revealAnswerSwitch = findViewById(R.id.questionPrivacy_finance1_toggleSwitch);

        saveAnswer = findViewById(R.id.save_finance_Question1_button);
        skipAnswer = findViewById(R.id.skip_finance_Question1_button);
    }
}
