...
import com.example.cupidshuffle.surveys.SurveyActivities.sexQuestions.SexQuestion1;
...
public class FinanceQuestion5 extends AppCompatActivity {
    ...
    private TextView financeQuestion5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finance_question5);

        financeQuestions = getResources().getStringArray(R.array.finance_surveyQuestions_array);
        financeQuestion5_choices = getResources().getStringArray(R.array.finance_surveyChoices_question5_array);
    ...
    private void setViews() {
        financeQuestion5.setText(financeQuestions[4]);

        yourChoice1.setText(financeQuestion5_choices[0]);
        yourChoice2.setText(financeQuestion5_choices[1]);
        yourChoice3.setText(financeQuestion5_choices[2]);
        yourChoice4.setText(financeQuestion5_choices[3]);

        acceptedChoice1.setText(financeQuestion5_choices[0]);
        acceptedChoice2.setText(financeQuestion5_choices[1]);
    ...
    private void findViews() {
        financeQuestion5 = findViewById(R.id.finance_question5_text);

        yourChoices = findViewById(R.id.finance_question5_radioGroup);
        yourChoice1 = findViewById(R.id.finance_question5_yourChoice1_button);
        yourChoice2 = findViewById(R.id.finance_question5_yourChoice2_button);
        yourChoice3 = findViewById(R.id.finance_question5_yourChoice3_button);
        yourChoice4 = findViewById(R.id.finance_question5_yourChoice4_button);

        acceptedChoice1 = findViewById(R.id.finance_question5_acceptedChoice1_checkbox);
        acceptedChoice2 = findViewById(R.id.finance_question5_acceptedChoice2_checkbox);
        acceptedChoice3 = findViewById(R.id.finance_question5_acceptedChoice3_checkbox);
        acceptedChoice4 = findViewById(R.id.finance_question5_acceptedChoice4_checkbox);

        explainAnswer = findViewById(R.id.explainAnswer_finance5_editText);
        revealAnswerSwitch = findViewById(R.id.questionPrivacy_finance5_toggleSwitch);

        saveAnswer = findViewById(R.id.save_finance_Question5_button);
        skipAnswer = findViewById(R.id.skip_finance_Question5_button);
    }
}